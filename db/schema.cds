...
SOP_Type : String;
Order_Type_OR_Document_type : String;
Asset_Type : String;
...
Number_of_Back_to_back_Terms_agreed_with_Vendor_as_per_GPC_OR_GCC : String;
   ...
   tab1tovendor_response_summary_table : Composition of many vendor_response_summary_table on tab1tovendor_response_summary_table.vendor_response_summary_tabletotab1 = $self;
...
entity vendor_response_summary_table {
